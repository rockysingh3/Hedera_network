...
class AccountInfo {
  ...
  static _fromProtobuf(info) {
    ...
    const accountId = _AccountId.default._fromProtobuf(
    ...
    return new AccountInfo({
      ...
      hbarAllowances: (info.grantedCryptoAllowances != null ? info.grantedCryptoAllowances : []).map(allowance => _HbarAllowance.default._fromGrantedProtobuf(allowance, accountId)),
      tokenAllowances: (info.grantedTokenAllowances != null ? info.grantedTokenAllowances : []).map(allowance => _TokenAllowance.default._fromGrantedProtobuf(allowance, accountId)),
      nftAllowances: (info.grantedNftAllowances != null ? info.grantedNftAllowances : []).map(allowance => _TokenNftAllowance.default._fromGrantedProtobuf(allowance, accountId))
    });
  }
  /**
