...
class TokenUpdateTransaction extends _Transaction.default {
  ...
  static _fromProtobuf(transactions, signedTransactions, transactionIds, nodeIds, bodies) {
    ...
    return _Transaction.default._fromProtobufTransactions(new TokenUpdateTransaction({
      ...
      kycKey: update.kycKey != null ? _Key.default._fromProtobufKey(update.kycKey) : undefined,
      freezeKey: update.freezeKey != null ? _Key.default._fromProtobufKey(update.freezeKey) : undefined,
      wipeKey: update.wipeKey != null ? _Key.default._fromProtobufKey(update.wipeKey) : undefined,
      supplyKey: update.supplyKey != null ? _Key.default._fromProtobufKey(update.supplyKey) : undefined,
