 ...
 * @returns {T}
 */
export function requireNotNegative<T extends Long.Long | import("./Hbar.js").default>(variable: T): T;
/**
 ...
 * @returns {boolean}
 */
export function compare(a: any, b: any, ignore?: Set<string> | undefined): boolean;
/**
