...
declare namespace Status {
    ...
    const RoyaltyFractionCannotExceedOne: Status;
    ...
    const SerialNumberLimitReached: Status;
    const CustomRoyaltyFeeOnlyAllowedForNonFungibleUnique: Status;
    const NoRemainingAutomaticAssociations: Status;
    const ExistingAutomaticAssociationsExceedGivenLimit: Status;
    const RequestedNumAutomaticAssociationsExceedsAssociationLimit: Status;
    const TokenIsPaused: Status;
    const TokenHasNoPauseKey: Status;
    const InvalidPauseKey: Status;
    const FreezeUpdateFileDoesNotExist: Status;
    const FreezeUpdateFileHashDoesNotMatch: Status;
    const NoUpgradeHasBeenPrepared: Status;
    const NoFreezeIsScheduled: Status;
    const UpdateFileHashChangedSincePrepareUpgrade: Status;
    const FreezeStartTimeMustBeFuture: Status;
    const PreparedUpdateFileIsImmutable: Status;
    const FreezeAlreadyScheduled: Status;
    const FreezeUpgradeInProgress: Status;
    const UpdateFileIdDoesNotMatchPrepared: Status;
    const UpdateFileHashDoesNotMatchPrepared: Status;
    const ConsensusGasExhausted: Status;
    const RevertedSuccess: Status;
    const MaxStorageInPriceRegimeHasBeenUsed: Status;
    const InvalidAliasKey: Status;
    const UnexpectedTokenDecimals: Status;
    const InvalidProxyAccountId: Status;
    const InvalidTransferAccountId: Status;
    const InvalidFeeCollectorAccountId: Status;
    const AliasIsImmutable: Status;
    const SpenderAccountSameAsOwner: Status;
    const AmountExceedsTokenMaxSupply: Status;
    const NegativeAllowanceAmount: Status;
    const CannotApproveForAllFungibleCommon: Status;
    const SpenderDoesNotHaveAllowance: Status;
    const AmountExceedsAllowance: Status;
    const MaxAllowancesExceeded: Status;
    const EmptyAllowances: Status;
    const SpenderAccountRepeatedInAllowances: Status;
    const RepeatedSerialNumsInNFTAllowances: Status;
    const FungibleTokenInNFTAllowances: Status;
    const NFTInFungibleTokenAllowances: Status;
    const PayerAndOwnerNotEqual: Status;
}
