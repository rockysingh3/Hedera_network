...
var _IPv4Address = _interopRequireDefault(require("./IPv4Address.cjs"));
...
class EndPoint {
  ...
  static _fromProtobuf(endpoint) {
    return new EndPoint({
      address: endpoint.ipAddressV4 != null ? _IPv4Address.default._fromProtobuf(endpoint.ipAddressV4) : undefined,
