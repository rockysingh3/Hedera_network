...
class PublicKey extends _Key.default {
  ...
  toAccountId(shard, realm) {
    if (_Cache.default.accountIdConstructor == null) {
...
_Cache.default.publicKeyED25519 = key => PublicKey.fromBytesED25519(key);

_Cache.default.publicKeyECDSA = key => PublicKey.fromBytesECDSA(key);