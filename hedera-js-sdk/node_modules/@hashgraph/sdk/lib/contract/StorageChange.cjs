...
class StorageChange {
  ...
  static fromBytes(bytes) {
    return StorageChange._fromProtobuf(HashgraphProto.proto.StorageChange.decode(bytes));
  }
  /**
   * @internal
  ...
  toBytes() {
    return HashgraphProto.proto.StorageChange.encode(this._toProtobuf()).finish();
  }
