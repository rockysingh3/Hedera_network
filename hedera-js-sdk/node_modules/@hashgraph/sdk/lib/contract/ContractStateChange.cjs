...
class ContractStateChange {
  ...
  static fromBytes(bytes) {
    return ContractStateChange._fromProtobuf(HashgraphProto.proto.ContractStateChange.decode(bytes));
  }
  /**
   * @internal
  ...
  toBytes() {
    return HashgraphProto.proto.ContractStateChange.encode(this._toProtobuf()).finish();
  }
