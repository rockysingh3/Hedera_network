...
var _keccak = require("../cryptography/keccak.cjs");
...
class ContractFunctionSelector {
  ...
  _build(name) {
    ...
    return hex.decode((0, _keccak.keccak256)(`0x${func}`)).slice(0, 4);
  }
  /**
   * @returns {string}
   */
