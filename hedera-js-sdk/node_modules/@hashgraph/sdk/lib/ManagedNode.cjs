...
var _ManagedNodeAddress = _interopRequireDefault(require("./ManagedNodeAddress.cjs"));
...
class ManagedNode {
  ...
  constructor(props = {}) {
    if (props.newNode != null) {
      this._address = typeof props.newNode.address === "string" ? _ManagedNodeAddress.default.fromString(props.newNode.address) : props.newNode.address;
      /** @type {string=} */
