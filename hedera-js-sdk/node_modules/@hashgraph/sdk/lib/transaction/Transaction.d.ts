...
export default class Transaction extends Executable<HashgraphProto.proto.ITransaction, HashgraphProto.proto.ITransactionResponse, TransactionResponse> {
     ...
     */
    _signTransaction(): Promise<HashgraphProto.proto.ISignedTransaction>;
     ...
     */
    _buildTransactionAsync(): Promise<HashgraphProto.proto.ITransaction>;
    /**
     * @internal
...
export type Signer = import("../Signer.js").default;
