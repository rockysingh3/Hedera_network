...
class NetworkVersionInfo {
  ...
  static fromBytes(bytes) {
    return NetworkVersionInfo._fromProtobuf(HashgraphProto.proto.NetworkGetVersionInfoResponse.decode(bytes));
  }
  /**
   * @returns {Uint8Array}
   */
  ...
  toBytes() {
    return HashgraphProto.proto.NetworkGetVersionInfoResponse.encode(this._toProtobuf()).finish();
  }
