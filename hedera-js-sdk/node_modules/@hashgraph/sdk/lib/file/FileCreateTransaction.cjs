...
class FileCreateTransaction extends _Transaction.default {
  ...
  constructor(props = {}) {
    ...
    this._expirationTime = new _Timestamp.default(0, 0).plusNanos(_long.default.fromNumber(Date.now()).mul(1000000).add(_Transaction.DEFAULT_AUTO_RENEW_PERIOD.mul(1000000000)));
    /**
     * @private
     * @type {?Uint8Array}
     */
